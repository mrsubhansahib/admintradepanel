...
<body>
    ...
    <div class="preloader">
        <div id="preloader">
            <img class="icon" src="{{ siteFavicon() }}" alt="images">
        </div>
    </div>
    ...
    @if (!in_array(request()->route()->getName(), ['user.register', 'user.login', 'maintenance']))
        @include($activeTemplate . 'partials.header')
        @if (!request()->routeIs('home'))
            @include($activeTemplate . 'sections.breadcrumb')
        @endif
    @endif
