...
<div class="register-disable">
    <div class="container">
        ...
        <h6 class="register-disable-title">{{ __(@$registrationDisabled->data_values->heading) }}</h6>
        ...
        <div class="text-center">
            <a href="{{ @$registrationDisabled->data_values->button_url }}"
                class="register-disable-footer-link">{{ __(@$registrationDisabled->data_values->button_name) }}</a>
        </div>
    </div>
</div>
