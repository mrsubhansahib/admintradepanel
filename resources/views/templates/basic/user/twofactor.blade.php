        ...
        <div class="row justify-content-center gy-4">
                ...
                <div class="col-md-6">
                    <div class="card custom--card">
                        <div class="card-header">
                            <h6 class="card-title">@lang('Add Your Account')</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="input-group-text copytext text--white bg--base"
                                        id="copyBoard"> <i class="fas fa-copy"></i> </button>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                ...
                @if (auth()->user()->ts)
                    <div class="card custom--card">
                        <div class="card-header">
                            <h6 class="card-title">@lang('Disable 2FA Security')</h6>
                        </div>
                ...
                @else
                    <div class="card custom--card">
                        <div class="card-header">
                            <h6 class="card-title">@lang('Enable 2FA Security')</h6>
                        </div>
