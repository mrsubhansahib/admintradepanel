...
@section('content')
    <form action="{{ route('user.withdraw.money') }}" method="post" class="withdraw-form">
        @csrf
        <div class="gateway-card pt-0">
            <div class="row justify-content-center gy-sm-4 gy-3">
                <div class="col-12">
                    <h6 class="payment-card-title">@lang('Withdraw')</h6>
                </div>
                <div class="col-lg-6">
                    <div class="payment-system-list is-scrollable gateway-option-list pt-0 pb-0">
                        ...
                        @if ($withdrawMethod->count() > 4)
                            <button type="button" class="payment-item__btn more-gateway-option  btn--base">
