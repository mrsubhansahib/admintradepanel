                            ...
                            <ul class="list-group">
                                @foreach ($wallets as $wallet)
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        {{ $wallet->currency->name }}<span
                                            class="font-weight-bold">{{ showAmount($wallet->amount, currencyFormat: false) }}
                                            {{ __($wallet->currency->cur_text) }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" data-width="100%" data-height="50"
                                                ...
                                                data-on="@lang('Enable')" data-off="@lang('Disable')" name="ts"
                                    ...
                                    <div class="col-xl-3 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" data-width="100%" data-height="50"
                                                data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle"
                                                data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv"
