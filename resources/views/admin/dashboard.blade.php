        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <a href="{{ route('admin.cryptocurrency') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-coins"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $totalCurrency }}
                                    </h6>
                                    <p class="widget-card-title">@lang('Total Currency')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $activeCurrency }}</h6>
                                    <p class="widget-card-title">@lang('Active Currency')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="{{ route('admin.setting.general') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-wallet"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ __(gs('cur_text')) }}</h6>
                                    <p class="widget-card-title">@lang('Default Currency')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $pendingSupportTicket }}</h6>
                                    <p class="widget-card-title">@lang('Pending Ticket')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two box--shadow2 b-radius--5 bg--white">
                        <div class="widget-two__icon b-radius--5 text--success">
                            <img alt="image"
                                src="{{ getImage(getFilePath('cryptoCurrency') . '/' . @$withdrawal->image, getFileSize('cryptoCurrency')) }}">
                        </div>
                        <div class="widget-two__content">
                            <h3>{{ showAmount(@$withdrawal->withdrawals_sum_amount, 8) }} {{ __(@$withdrawal->cur_text) }}
                            </h3>
                            <span>@lang('Charge')</span>
                            <i class="fas fa-arrow-right text--danger"></i>
                            <span class="text--danger">{{ showAmount(@$withdrawal->withdrawals_sum_charge, 8) }}
                                {{ __(@$withdrawal->cur_text) }}</span>
                        </div>
                        <a class="widget-two__btn border border--success btn-outline--success"
                            href="{{ route('admin.withdraw.data.all') }}">@lang('View All')</a>
                    </div>
                </div>
            @endforeach
        </div>
