...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $withdrawals = Currency::withSum(['withdrawals' => function ($withdrawals) {
        ...
        $totalCurrency        = Currency::all()->count();
        $activeCurrency       = Currency::where('status', Status::ENABLE)->count();
        $pendingSupportTicket = SupportTicket::whereIn('status', [Status::TICKET_OPEN, Status::TICKET_REPLY])->count();


        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'activeCurrency', 'totalCurrency', 'pendingSupportTicket'));
    }
