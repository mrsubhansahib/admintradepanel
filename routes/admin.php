...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CryptocurrencyController')->prefix('crypto/currency')->group(function () {
        Route::get('index', 'index')->name('cryptocurrency');
        Route::post('status/{id}', 'status')->name('cryptocurrency.status');
        Route::post('store/{id?}', 'store')->name('cryptocurrency.store');
        Route::post('api/store', 'apiStore')->name('cryptocurrency.api.store');
    });
